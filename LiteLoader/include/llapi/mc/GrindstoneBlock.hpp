...
//private:
    /**
     * @symbol ?_determineAttachment\@GrindstoneBlock\@\@AEBAAEBVBlock\@\@AEBVActor\@\@AEBVBlockPos\@\@E\@Z
     */
    MCAPI class Block const & _determineAttachment(class Actor const &, class BlockPos const &, unsigned char) const;
    /**
