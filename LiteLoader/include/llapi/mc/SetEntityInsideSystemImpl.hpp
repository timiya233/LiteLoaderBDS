/**
 * @file  SetEntityInsideSystemImpl.hpp
 *
 */
#pragma once
...
class SetEntityInsideSystemImpl {

#define AFTER_EXTRA

#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SETENTITYINSIDESYSTEMIMPL
public:
    class SetEntityInsideSystemImpl& operator=(class SetEntityInsideSystemImpl const &) = delete;
    SetEntityInsideSystemImpl(class SetEntityInsideSystemImpl const &) = delete;
    SetEntityInsideSystemImpl() = delete;
#endif
