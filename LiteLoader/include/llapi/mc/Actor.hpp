...
//protected:
    ...
    /**
     * @symbol ?_getPredictedMovementComponent\@Actor\@\@IEBAAEBVPredictedMovementComponent\@\@XZ
     */
    MCAPI class PredictedMovementComponent const & _getPredictedMovementComponent() const;
    /**
     * @symbol ?_getPredictedMovementComponentNonConst\@Actor\@\@IEAAAEAVPredictedMovementComponent\@\@XZ
     */
