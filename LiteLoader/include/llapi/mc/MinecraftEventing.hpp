...
//private:
    ...
    /**
     * @symbol ?fireSummaryEventEntitySpawned\@MinecraftEventing\@\@CAXAEAVEventManager\@Events\@Social\@\@HII\@Z
     */
    MCAPI static void fireSummaryEventEntitySpawned(class Social::Events::EventManager &, int, unsigned int, unsigned int);
