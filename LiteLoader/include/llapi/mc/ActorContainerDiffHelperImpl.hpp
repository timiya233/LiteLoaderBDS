...
#undef AFTER_EXTRA
    ...
    /**
     * @symbol ?_applyDiff\@ActorContainerDiffHelperImpl\@\@YAXAEAV?$vector\@VMobEffectInstance\@\@V?$allocator\@VMobEffectInstance\@\@\@std\@\@\@std\@\@AEBV?$vector\@V?$not_null\@PEBVMobEffectInstance\@\@\@gsl\@\@V?$allocator\@V?$not_null\@PEBVMobEffectInstance\@\@\@gsl\@\@\@std\@\@\@3\@\@Z
     */
    MCAPI void _applyDiff(std::vector<class MobEffectInstance> &, std::vector<class gsl::not_null<class MobEffectInstance const *>> const &);
    /**
