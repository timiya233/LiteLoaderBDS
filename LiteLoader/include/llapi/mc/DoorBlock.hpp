...
public:
    ...
    /**
     * @symbol ?hasRightHinge\@DoorBlock\@\@QEBA_NAEBVIConstBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI bool hasRightHinge(class IConstBlockSource const &, class BlockPos const &) const;
    /**
