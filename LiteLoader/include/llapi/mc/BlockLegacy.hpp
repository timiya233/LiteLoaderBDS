...
//private:
    ...
    /**
     * @symbol ?makeInvalidStateMessage\@BlockLegacy\@\@AEBA?AV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@AEBVBlockState\@\@\@Z
     */
    MCAPI std::string makeInvalidStateMessage(class BlockState const &) const;
    /**
     * @symbol ?makeInvalidStateMessage\@BlockLegacy\@\@AEBA?AV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@AEB_K\@Z
     */
    MCAPI std::string makeInvalidStateMessage(unsigned __int64 const &) const;
