...
//private:
    ...
    /**
     * @symbol ?_stringToChatFloodingAction\@CommunitySiftProcessor\@\@CA?AW4ChatFloodingAction\@Safety\@\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@\@Z
     */
    MCAPI static enum class Safety::ChatFloodingAction _stringToChatFloodingAction(std::string const &);
