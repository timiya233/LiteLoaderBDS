...
public:
    /**
     * @symbol ?_setPositionRequestSystem\@VehicleClientPositionPassengerSystem\@\@SAXV?$ViewT\@VStrictEntityContext\@\@VEntityRegistryBase\@\@$$CBUSynchedActorDataComponent\@\@\@\@V?$ViewT\@VStrictEntityContext\@\@VEntityRegistryBase\@\@$$CBURenderPositionComponent\@\@$$CBURenderRotationComponent\@\@\@\@V?$OptionalGlobalT\@UPassengersToPositionComponent\@\@VEntityRegistryBase\@\@\@\@V?$EntityModifierT\@VEntityRegistryBase\@\@VStrictEntityContext\@\@UActorSetPositionRequestComponent\@\@\@\@\@Z
     */
    MCAPI static void _setPositionRequestSystem(class ViewT<class StrictEntityContext, class EntityRegistryBase, struct SynchedActorDataComponent const>, class ViewT<class StrictEntityContext, class EntityRegistryBase, struct RenderPositionComponent const, struct RenderRotationComponent const>, class OptionalGlobalT<struct PassengersToPositionComponent, class EntityRegistryBase>, class EntityModifierT<class EntityRegistryBase, class StrictEntityContext, struct ActorSetPositionRequestComponent>);
    /**
