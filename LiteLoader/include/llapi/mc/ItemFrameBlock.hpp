...
//private:
    /**
     * @symbol ?_addMapCollection\@ItemFrameBlock\@\@AEBAHAEAV?$vector\@PEAVMapItemSavedData\@\@V?$allocator\@PEAVMapItemSavedData\@\@\@std\@\@\@std\@\@AEBVBlockPos\@\@AEAVBlockSource\@\@\@Z
     */
    MCAPI int _addMapCollection(std::vector<class MapItemSavedData *> &, class BlockPos const &, class BlockSource &) const;
    /**
