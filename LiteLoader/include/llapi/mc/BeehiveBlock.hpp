...
//private:
    ...
    /**
     * @symbol ?_getBeehiveBlockActor\@BeehiveBlock\@\@AEBAPEAVBeehiveBlockActor\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI class BeehiveBlockActor * _getBeehiveBlockActor(class BlockSource &, class BlockPos const &) const;
    /**
